...
if [[ $HOSTNAME == hfe* ]]; then
  NAME=hera
  GROUP=nems
  BASEDIR=/scratch1/NCEPDEV
  STMP=stmp4
  PTMP=stmp2
  # WORKDIR=/scratch1/NCEPDEV/nems/${USER}/autort/pr
  # NEW_BASELINE=/scratch1/NCEPDEV/stmp4/${USER}/FV3_RT/REGRESSION_TEST
  # BLDIR=/scratch1/NCEPDEV/nems/${USER}/RT/NEMSfv3gfs
...
python rt_auto.py -m $MACHINE_NAME -w $WORKDIR -b $BLDIR
